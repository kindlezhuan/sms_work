...
<html>
  <head>
    ...
    <script src="js/sms_user/sms_addressBook_addGroup.js" charset="UTF-8"></script>
    <script src="js/utils/MonthField.js"></script>
    <script src="js/utils/gbicc-component.js"></script>
</head>
<body>
