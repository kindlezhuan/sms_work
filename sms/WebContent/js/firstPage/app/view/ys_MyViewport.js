...
Ext.define('MyApp3.view.ys_MyViewport', {
...
//                            hidden:true,
                            handler: function () {
                                LoadChildMenus("js/firstPage/menus/ys/menus.json");
                            },
                            width: 120
                        }, '-', {
                            xtype: 'button',
                            text: '智能监控',
                            handler: function () {
                                LoadChildMenus("js/firstPage/menus/ys/menus2.json");
                            },
                            width: 120
                        }, '-', {
                            xtype: 'button',
                            text: '企业管理',
                            handler: function () {
                                LoadChildMenus("js/firstPage/menus/ys/menus3.json");
                            },
                            width: 120
                        }, '-', {
                            xtype: 'button',
                            text: '固废转移',
                            handler: function () {
                            	LoadChildMenus("js/firstPage/menus/ys/menus4.json");
                            },
                            width: 120
                        }, '->', {
                            xtype: 'label',
